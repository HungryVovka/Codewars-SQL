...
-- returns only the films that have only "Trailers" and "Deleted Scenes" as their special features. special_features is the text[] type. It represents 
...
FROM film AS res
WHERE 
    ARRAY['Trailers', 'Deleted Scenes']::TEXT[] = special_features OR
    ARRAY['Deleted Scenes', 'Trailers']::TEXT[] = special_features
